...
async def march_quest_handler(message: Message):
    ...
    quests = {
        1: "📸 Сфоткай себя с утра — только проснулась, без фильтров, как есть. Мне нравишься именно такая.",
        2: "🎵 Пришли мне 3 трека, которые ты бы поставила если бы мы были вдвоём.",
        3: "🫦 Запиши голосовое и расскажи одну фантазию обо мне и тебе. Не торопись, я хочу слышать подробно 😏",
        4: "🌸 Прогуляйся сегодня и найди что-нибудь красивое вокруг — цветок, небо, дерево. Скинь фото.",
        5: "👗 Оденься в то, в чём чувствуешь себя самой красивой — и скинь фото в зеркале.",
        6: "💋 Накрась губы любимой помадой и скинь крупное фото. Просто хочу видеть.",
        7: "🛁 Прими горячую ванну с пеной или долгий душ с любимым гелем. Потом запиши голосовое — что чувствовала.",
        8: "🌙 Опиши мне голосовым идеальный вечер со мной. Где, как, что — в деталях, не стесняйся.",
        9: "☕️ Сними кружочек как ты делаешь утренний кофе или чай. Просто хочу видеть тебя с утра.",
        10: "💃 Потанцуй дома под любимую песню и скинь кружочек. Мне всё равно как — главное ты.",
        11: "🤫 Напиши мне одну вещь, которую давно хочешь от меня — но каждый раз не решаешься попросить.",
        12: "🌙 Ляг в постель и запиши голосовое — что чувствуешь прямо сейчас и о чём думаешь.",
        13: "📸 Найди своё любимое фото из наших поездок и скинь мне. Напиши почему именно это.",
        14: "🌹 Напиши 5 вещей, за которые ты мне благодарна прямо сейчас. Любых — больших и маленьких.",
        15: "💆‍♀️ Сделай себе массаж шеи и плеч сегодня — сама или попроси кого-то. Расскажи голосовым как было.",
        16: "😌 Скинь фото в том, что ты надеваешь когда хочешь произвести впечатление. Хочу знать твоё секретное оружие.",
        17: "🌅 Встань сегодня чуть раньше и сфоткай утреннее небо или вид из окна.",
        18: "🫦 Запиши мне голосовое — что тебе больше всего нравится когда мы вместе. Честно, без стеснения.",
        19: "🌸 Сделай сегодня что-нибудь только для себя — маска, крем, уход за собой. Покажи фото.",
        20: "😈 Опиши мне голосовым место на своём теле, которое тебе самой больше всего нравится. Мне правда интересно.",
        21: "🌳 Прогуляйся 20 минут в тишине — без музыки и телефона. Потом напиши, что думала о нас.",
        22: "🍷 Налей вечером бокал вина или любимого напитка, приглуши свет. Скинь атмосферное фото.",
        23: "💄 Сделай себе макияж как нравится — яркий или нежный, неважно. Скинь селфи.",
        24: "🔥 Напиши мне самое смелое желание, которое хочешь со мной исполнить. Я не испугаюсь — обещаю.",
        25: "📸 Селфи прямо сейчас, как есть — без подготовки и без фильтров. Ты всегда хороша.",
        26: "🕯 Зажги вечером свечу, выключи верхний свет. Скинь фото — хочу почувствовать твою атмосферу.",
        27: "🤸‍♀️ Сделай 10 приседаний и скинь кружочек. Можно медленно и с улыбкой 😏",
        28: "💌 Запиши мне голосовое как будто я очень далеко. Скажи что хочешь когда наконец увидимся.",
        29: "🌙 Перед сном запиши голосовое — что думала обо мне сегодня. Пусть даже мелочи.",
        30: "🌹 Запиши голосовое — что тебе больше всего нравится в нас двоих. Честно и от сердца.",
        31: "🎉 Месяц пройден! Назови одно желание, которое хочешь исполнить со мной — и мы это устроим."
    }
